...
export const getCurrentMovementsDocumentsBusiness = (payload) => {
  return (dispatch, getState) => {
    ...
    API.post('tunexo', '/facturacion/getCurrentMovementsDocumentsBusiness', {body: payload})
      .then((data) => {
        console.log('getCurrentMovementsDocumentsBusiness resultado', data);
        dispatch({type: GET_CURRENT_MOVEMENTS_DOCUMENTS, payload: data.response.payload});
