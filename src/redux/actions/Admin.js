...
export const upgradeProductive = (payload) => {
  return (dispatch, getState) => {
    dispatch({type: FETCH_START});
    API.post('tunexo', '/business/administrative/upgradebusinesstoprod', {
      body: payload,
    })
      .then((data) => {
  ...
  return async (dispatch, getState) => {
    ...
    try {
      const data = await API.post(
        'tunexo',
        '/business/administrative/activesunat',
        {body: payload},
      );
...
export const extendSuscriptionBusiness = (payload) => {
  return (dispatch, getState) => {
    dispatch({type: FETCH_START});
    API.post('tunexo', '/business/administrative/extendsucription', {
      body: payload,
    })
      .then((data) => {
...
export const ableBusiness = (payload) => {
  return (dispatch, getState) => {
    dispatch({type: FETCH_START});
    API.post('tunexo', '/business/administrative/changestatusbusiness', {
      body: payload,
    })
      .then((data) => {
