import { Box, ButtonGroup,Grid,Button,TextField,Dialog, DialogActions,
    DialogContent,
    DialogContentText,
...
const EditorMessage=(props)=>{
    ...
    const handleBoldMessage = () => {
      ...
      const handleItalicsMessage = () => {
        ...
        const cursorPosition = textarea.selectionStart;
        if (cursorPosition !== undefined) {
            console.log("posicion text",props.getValueField('campaignContent').value);
          const currentText = props.getValueField('campaignContent').value;
          const newText =
            currentText.slice(0, cursorPosition) +
            updatedTextMessage +
      ...
      const handleStrikethrough = () => {
        ...
        if (cursorPosition !== undefined) {
          const currentText = props.getValueField('campaignContent').value;
          console.log("CampaignContent getvalue",props.getValueField('campaignContent').value)
          const newText =
            currentText.slice(0, cursorPosition) +
            updatedTextMessage +
            currentText.slice(cursorPosition);
