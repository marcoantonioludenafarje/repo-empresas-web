...
import {getAgents, deleteAgents, startAgentSession} from '../../../../redux/actions/Agent';
    ...
    <Card sx={{p: 4}}>
      ...
      >
        ...
        <Button  variant='contained'  onClick={reset}>
          ...
          openQRSuccess == false && !imgQR ? (
            ...
            <Button sx={{mt:2}} onClick={startSession} variant='contained' startIcon={<QrCodeIcon />}>
              Generar QR
            </Button>
          ) : null}
          {openLimitQR === true ? (
            <>
              ...
              <Button onClick={startSession} variant='contained' startIcon={<QrCodeIcon />}>
                Generar QR
              </Button>
            </>
          ) : null}
      ...
      >
        ...
        {localStorage
          ...
          <MenuItem disabled={selectedAgent.status=='ON'} onClick={setEnableState}>
