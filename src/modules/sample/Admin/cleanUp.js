...
import {clearS3Objects} from '../../../redux/actions/Admin';
//ESTILOS
...
const CleanUp = (props) => {
  ...
  const [openCleanConfirmation, setOpenCleanConfirmation] =
  ...
  const showMessage = () => {
    ...
    } else if (clearS3ObjectsRes && clearS3ObjectsRes.name == 'Error') {
      return (
        <>
      ...
      <Card sx={{p: 4}}>
        ...
        >
          <FormControl fullWidth>
            <InputLabel id='folder-label' style={{fontWeight: 200}}>
              Carpeta
            </InputLabel>
            <Select
            ...
            >
              <MenuItem value='qr' style={{fontWeight: 200}}>
                {'QR'}
              </MenuItem>
              <MenuItem value='provisional' style={{fontWeight: 200}}>
                {'Provisional'}
              </MenuItem>
            </Select>
          </FormControl>
      ...
      >
        ...
        <DialogContent sx={{display: 'flex', justifyContent: 'center'}}>
          ...
          <DialogContentText
            ...
            id='alert-dialog-description'
          >
            ¿Desea eliminar realmente todos los archivos? Esta operación no
            podrá revertirse
          </DialogContentText>
        </DialogContent>
        <DialogActions sx={{justifyContent: 'center'}}>
