...
import {getSpecialists, deleteSpecialists} from '../../../redux/actions/Specialist';
...
export default function Views(props) {
  ...
  const filterSpecialists = (searchText) => {
    if (!searchText) {
      ...
      specilist.specialistName.toLowerCase().includes(searchText.toLowerCase()),
      );
  ...
  return (
    <Card sx={{p: 4}}>
      ...
      <span>{`Items: ${listSpecialists ? listSpecialists.length : 'Cargando...'}`}</span>
