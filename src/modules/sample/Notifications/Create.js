...
const NewClient = (props) => {
  ...
  useEffect(()=>{
    ...
    if(getValueField('tipoEvento').value!='' && getValueField('tipoEvento').value.typeEvent=='SCHEDULED' && getValueField('channelNotification').value!=''){
                        ...
                        <Grid item xs={6}>
                          <FormControl fullWidth sx={{my: 2}}>
                            ...
                            <Select
                              ...
                              defaultValue={selectedNotification.notificationsChannel[ChannelSelected].periodicityAction.unit}
                            >
