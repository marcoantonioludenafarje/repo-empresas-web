...
const AddProductForm = ({ sendData, type, igvEnabled, igvDefault }) => {
    ...
    const addProduct = (obj) => {
        ...
        if (obj.unitMeasure == "ZZ" || (selectedProduct && selectedProduct.isStockNeeded === false)) {
    ...
    const handleTypeElement = (event) => {
        ...
        if (event.target.value == "ZZ" || (selectedProduct && selectedProduct.isStockNeeded === false)) {
            setStockChange(false)
        } else {
            setStockChange(true)
        }
                                    ...
                                    >
                                        ...
                                        >
                                            <FormControlLabel
                                                ...
                                                disabled={typeElement == "ZZ" || (selectedProduct && selectedProduct.isStockNeeded === false)}
                                                checked={stockChange}
                                                control={
                                                    <Checkbox
