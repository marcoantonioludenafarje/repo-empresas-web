        ...
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Stack direction="row" spacing={2} alignItems="center">
              <Button
                disabled={
                  !localStorage.getItem('pathsBack').includes(
                    '/utility/preSignAnyPathMerchant?path=/*'
                  )
                }
                variant="contained"
                color="primary"
          ...
          {getDataRes && getDataRes.objects && typeof getDataRes.objects !== 'string' ? (
            <Grid item>
              <Typography
                sx={{
                  letterSpacing: 2,
        ...
        <TableContainer component={Paper} sx={{maxHeight: 440, width: '100%'}}>
          ...
          <TableBody>
            ...
            typeof getDataRes.objects !== 'string' ? (
              getDataRes.objects
                .filter((obj) => obj.nameFile !== 'initialFolder.txt' && obj.nameFile !== 'initialFolder')
